...
cargos = [cepesp.CARGO.PRESIDENTE,
          cepesp.CARGO.GOVERNADOR,
          cepesp.CARGO.SENADOR,
          cepesp.CARGO.DEPUTADO_FEDERAL,
          cepesp.CARGO.DEPUTADO_ESTADUAL,
          cepesp.CARGO.DEPUTADO_DISTRITAL,
          cepesp.CARGO.PREFEITO,
          cepesp.CARGO.VEREADOR]

anos = pd.DataFrame()
for cargo in cargos:
    if cargo in [cepesp.CARGO.PREFEITO, cepesp.CARGO.VEREADOR]:
...
for indice, linha in anos.iterrows():
    ...
    vc = cepesp.votos_x_candidatos(cargo=linha['cargo'],
                            ano=linha['ano'],
